                ...
                font-family: 'Orbitron' ,sans-serif;">GODLY LTD.</a>
                    ...
                    <div class="collapse navbar-collapse" id="myNavbar">
                      <ul class="nav navbar-nav">
                        ...
                        <li class="active"><a href="confirmed.php">Confirmed Orders</a></li>
                      </ul>
...
<!--
            <div class="row">
                <div class="col-xs-12">
                    <center><marquee style="width:20%;color:red;font-size:20px" behavior="alternate" >Welcome </marquee></center>
                </div>
            </div>
            <br>
-->
            ...
            <br>
        <?php
            $query="SELECT * FROM `item` ,`item_img`,`item_order` where             item.ID=item_img.itemid && item.ID=item_order.i_id && item_order.c_id='".$_SESSION['pid']."' && item_order.confirm=2 order by item.Name";
